...
const nextUpgrades = {
    ...
    Skrill: [
        // For all conversions to USD I have added a bit extra to factor currency conversions
        // {
        //     level: 'Silver',
...
const checkUpgradeOffer = ({ brand, transValue }) =>
    Promise.resolve(
        // this function either returns false or string of upgrade eg false || 'Gold'
...
const getQuarterData = ({ month }) => {
    // use this to find current quarter from month input // for some reaspon have to include this function here instead of requiring it from /quarter-helpers.js - otherwise Affreport in quarter-helpers.js does not work
    try {

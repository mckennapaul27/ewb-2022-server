...
var _require8 = require('../../utils/sib-transactional-templates'),
    sibRequestLinks = _require8.sibRequestLinks,
    sibPaymentDetailsUpdate = _require8.sibPaymentDetailsUpdate;

var _require9 = require('../../utils/notifications-list'),
    updatedPaymentDetails = _require9.updatedPaymentDetails,
    linksRequested = _require9.linksRequested;

var _require10 = require('../../utils/success-messages'),
    msgRequestedLinks = _require10.msgRequestedLinks;

var _require11 = require('../../utils/error-messages'),
    errRequestNotSuccess = _require11.errRequestNotSuccess; // POST /affiliate/partner/fetch-details/:_id
  ...
  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 8:
          regDate = _context4.sent.belongsTo.regDate;
          orQuery = {
            isGeneral: true,
            createdAt: {
              $gte: regDate
    ...
    while (1) {
      switch (_context7.prev = _context7.next) {
        ...
        case 6:
          ...
          return _context7.abrupt("return", res.status(200).send(partner));

...
var _require7 = require('../../utils/error-messages'),
    ...
    errIncorrectPassword = _require7.errIncorrectPassword;
...
var _require10 = require('../../utils/sib-transactional-templates'),
    ...
    sibForgotPassword = _require10.sibForgotPassword;

var _require11 = require('../../utils/helper-functions'),
    getLocaleFromPartnerUser = _require11.getLocaleFromPartnerUser; // /common/auth/create-new-user - THIS IS UP-TO-DATE 1/3/22
    ...
    if (!user) return res.status(401).send({
      ...
      user.checkPassword(req.body.password, function (err, isMatch) {
        if (isMatch && !err) {
          ...
          return res.status(401).send(errIncorrectPassword({
